...
- Venv Python : `.claude/skills/meeting-notes/scripts/venv` (créé par `bash .claude/skills/meeting-notes/scripts/setup.sh`)
- Compte Fathom (gratuit ou premium) avec accès API activé

## Lister les meetings

```python
import sys; sys.path.insert(0, '.claude/skills/meeting-notes/scripts')
...
```bash
source .claude/skills/meeting-notes/scripts/venv/bin/activate

python .claude/skills/meeting-notes/scripts/fathom_client.py meetings --limit 10 --with-summary
python .claude/skills/meeting-notes/scripts/fathom_client.py summary RECORDING_ID
python .claude/skills/meeting-notes/scripts/fathom_client.py transcript RECORDING_ID
python .claude/skills/meeting-notes/scripts/fathom_client.py resolve https://fathom.video/calls/12345
```
